...
CREATE TABLE `acbra2_chat` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=MEMORY AUTO_INCREMENT=279 DEFAULT CHARSET=utf8;
...
CREATE TABLE `acbra2_log` (
  ...
  PRIMARY KEY (`lid`)
) ENGINE=MEMORY AUTO_INCREMENT=45 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `acbra2_mapitem` (
  ...
  PRIMARY KEY (`iid`)
) ENGINE=MyISAM AUTO_INCREMENT=12703 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `acbra2_players` (
  ...
  `wepexp` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `sktime` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `typls` tinyint unsigned NOT NULL default '99',
  `tyowner` char(15) NOT NULL default '',
  `cursedsouls` int(10) NOT NULL default '0',
  `cdowner` char(15) NOT NULL default '',
  PRIMARY KEY (`pid`),
  KEY `TYPE` (`type`,`sNo`),
  KEY `NAME` (`name`,`type`)
...
) ENGINE=MyISAM AUTO_INCREMENT=29943 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `acbra3_chat` (
  ...
  `msg` char(60) NOT NULL DEFAULT '',
  PRIMARY KEY (`cid`)
) ENGINE=MEMORY AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `acbra3_game`
--

DROP TABLE IF EXISTS `acbra3_game`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acbra3_game` (
  `gamenum` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `gametype` int(10) NOT NULL DEFAULT '0',
  `gamestate` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `lastupdate` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `acbra3_mapitem` (
  ...
  `pls` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`iid`)
) ENGINE=MyISAM AUTO_INCREMENT=7701 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `acbra3_users`
--

DROP TABLE IF EXISTS `acbra3_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acbra3_users` (
  `uid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `username` char(15) NOT NULL DEFAULT '',
  `password` char(32) NOT NULL DEFAULT '',
  `groupid` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`uid`),
  UNIQUE KEY `username` (`username`)
) ENGINE=MyISAM AUTO_INCREMENT=27902 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `acbra3_winners`
--

DROP TABLE IF EXISTS `acbra3_winners`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acbra3_winners` (
  `gid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `type` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `name` char(15) NOT NULL DEFAULT '',
  `pass` char(32) NOT NULL DEFAULT '',
...
-- Dump completed on 2014-12-26  5:15:38
