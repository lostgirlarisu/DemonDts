...
$mixinfo = array
	...
	array('class' => 'wc', 'stuff' => array('集换卡片-天崎 凉子','集换卡片-天崎 奈奈'),'result' => array('苍白之血','WC',100,'∞','dr'),),
	array('class' => 'wc', 'stuff' => array('集换卡片-天崎 凉子','集换卡片-天崎 奈奈','集换卡片-东云 幽纪'),'result' => array('爆裂摇篮','WC',480,'∞','drN'),),
	array('class' => 'wc', 'stuff' => array('苍白之血','集换卡片-东云 幽纪'),'result' => array('爆裂摇篮','WC',480,'∞','drN'),),
	array('class' => 'wc', 'stuff' => array('集换卡片-Lugia','集换卡片-arkpanda','集换卡片-Ground0'),'result' => array('深渊巨力','WC',720,'∞','dNZ'),),
	...
	array('class' => 'wk', 'stuff' => array('悲叹之种','《曾伽·宗博尔特自传》','D.D.D','『Two Become One』'),'result' => array('『Last Remote』','WK',1000,1000,'ZNrfk'),),
	...
	array('class' => 'wg', 'stuff' => array('★阔剑地雷★','电磁发射装置'),'result' => array('【定向阔剑发射器】','WG',400,144,'dNo'),),
	array('class' => 'wg', 'stuff' => array('★M-200狙击步枪★','电磁发射装置'),'result' => array('【磁轨狙击步枪】','WJ',300,10,'eno'),),
	...
	array('class' => 'w', 'stuff' => array('硬币','纸铠甲'),'result' => array('投币式铠甲（未激活）','Y',1,1,'z'),),
	array('class' => 'w', 'stuff' => array('硬币','塑料铠甲'),'result' => array('投币式铠甲（未激活）','Y',1,1,'z'),),
	...
	array('class' => 'item', 'stuff' => array('作战代码指令集','可疑的发信器'),'result' => array('紧急情况指示器','Y',1,1,),),
...
/*	array('class' => 'mystery', 'stuff' => array('脸','脸'),'result' => array('☆人面宝石匣☆','jew',1,1,),),
	array('class' => 'mystery', 'stuff' => array('脸','水晶方块','脸'),'result' => array('★人面魔石匣★','gbox',1,1,),),
	array('class' => 'mystery', 'stuff' => array('白色方块','增幅设备'),'result' => array('准光折变晶体','Y',1,1,),),
	array('class' => 'mystery', 'stuff' => array('白色方块','巨大透镜'),'result' => array('光折变晶体','Y',1,1,),),
	array('class' => 'mystery', 'stuff' => array('黑色方块','蓝色方块'),'result' => array('哭泣的黑曜石','Y',1,1,),),
	array('class' => 'mystery', 'stuff' => array('英雄之力','翠榴石'),'result' => array('碧榴石〖Alexander〗','GEM',1,1,),),
	array('class' => 'mystery', 'stuff' => array('武神之魂','月长石'),'result' => array('淡蓝宝石〖Eltoner〗','GEM',1,1,),),
	array('class' => 'mystery', 'stuff' => array('青金石','月长石','翠榴石','猫眼石','红宝石','黑曜石'),'result' => array('光芒石','Y',1,1,'v',),),
	array('class' => 'mystery', 'stuff' => array('神之荣耀','神之远见','神之操控','神之装束','神之步伐'),'result' => array('★教皇帽★','DH',478,624,'AZ',),),
	array('class' => 'mystery', 'stuff' => array('王♂之守御','王♂之宝座','王♂之权力','王♂之眼界','王♂之宣言'),'result' => array('♂三尻冠♂','DH',478,624,'AZ',),),
	array('class' => 'mystery', 'stuff' => array('光芒石','★教皇帽★','♂三尻冠♂'),'result' => array('★三重冕★','DH',666,888,'hZV',),),
	array('class' => 'mystery', 'stuff' => array('棍棒','青金石','《魔女的魔导书》'),'result' => array('☆青金石法杖☆','WF',377,'∞','adO'),),
	array('class' => 'mystery', 'stuff' => array('美工刀','翠榴石','■DarthNote■[+4]'),'result' => array('☆翠榴石战刃☆','WK',314,277,'rdO'),),
	array('class' => 'mystery', 'stuff' => array('超级重锤','月长石','GS【HandSonic Ver.4】[+4]'),'result' => array('☆琥珀石重锤☆','WP',466,162,'NrO'),),
	array('class' => 'mystery', 'stuff' => array('长矛','红宝石','☆十星认证☆'),'result' => array('☆红宝石投枪☆','WC',492,'∞','dufO'),),
	array('class' => 'mystery', 'stuff' => array('假炸弹','黑曜石','☆★☆大打击☆★☆'),'result' => array('☆黑曜石灵弹☆','WD',422,'∞','dfO'),),
	array('class' => 'mystery', 'stuff' => array('老式火枪','猫眼石','英雄之证[+4]'),'result' => array('☆猫眼石火铳☆','WJ',191,7,'nNfO'),),*/
	...
	array('class' => 'hidden', 'stuff' => array('九系统管理钥匙','九老人的手记卷轴'),'result' => array('九系统的重启方法','Y',1,1,''),),
