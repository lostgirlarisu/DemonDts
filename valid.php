...
if($mode == 'enter') {
	...
	if ($gametype==1 && !check_solo_participater())
	{
		if(!($udata['groupid'] >= 6 || $cuser == $gamefounder)){
			gexit('本局为SOLO特殊局，你不是本次SOLO对决的参加者，无法进入游戏', __file__, __line__);
		}
	}
	...
	$pose = 0;
	$tactic = 0;
	//$icon = $icon ? $icon : rand(1,$iconlimit);//[u150914]
	$club = 0;
	
	//自义定头像[u150914]
	//echo $cuser;
	if (array_key_exists($cuser,$xiconlist)){
		if(!in_array($icon,$xiconlist[$cuser])){
	...
	$itm[1] = '面包'; $itmk[1] = 'HH'; $itme[1] = 120; $itms[1] = 25;
	$itm[2] = '矿泉水'; $itmk[2] = 'HS'; $itme[2] = 140; $itms[2] = 25;
	$itm[5] = '秋刀鱼罐头'; $itmk[5] = 'HB'; $itme[5] = 70; $itms[5] = 15;
	$itm[6] = '凑合的背包'; $itmk[6] = 'DB'; $itme[6] = 5; $itms[6] = 15;$itmsk[6] = '^';
	
	if ($gametype==2)
	{
		$art = '团队队徽'; $artk='A'; $arte = 1; $arts = 1; $artsk = 'EIqUW';
		$itms[1] = 25; $itms[2] = 25; $itms[5] = 25;
	}
	
	if ($gametype==1)
	{
		$itms[1] = 20; $itms[2] = 20; $itms[5] = 25;
		$itm[6] = '生命探测器'; $itmk[6] = 'ER'; $itme[6] = 3; $itms[6] = 1; $itmsk[6] = '';
	}
	...
	//$itm[5] = '【GOLD RUSH ELITE】'; $itmk[5] = 'm'; $itme[5] = 100; $itms[5] = 1; $itmsk[5] = 'vZ';
...
//	}
	...
	if ($name == 'Amarillo_NMC') {
		...
		$icon = 255;
		$arb = '亚莉丝的朴素连衣裙';$arbk = 'DB'; $arbe = 200; $arbs = 200; $arbsk = 'Hv';
		$arh = '亚莉丝的遮阳草帽';$arhk = 'DH'; $arhe = 200; $arhs = 200; $arhsk = 'Av';
		//$ara = '皇家钻戒';$arak = 'DA'; $arae = 1600; $aras = 120; $arask = 'a';
		$arf = '亚莉丝的露趾凉鞋';$arfk = 'DF'; $arfe = 200; $arfs = 200; $arfsk = 'av';
		$art = '测试用索敌装置';$artk = 'A'; $arte = 10; $arts = 10; $artsk = 'vx';
		//$art = '贤者之石';$artk = 'A'; $arte = 9999; $arts = 999; $artsk = 'H';
		//$itm[4] = '广域生命探测器'; $itmk[4] = 'ER'; $itme[4] = 200; $itms[4] = 1; $itmsk[4] = '2';
		$itm[5] = '亚莉丝的神奇药剂'; $itmk[5] = 'Y'; $itme[5] = 1; $itms[5] = 1; $itmsk[5] = 'v';
		$itm[6] = '《时尚周刊》'; $itmk[6] = 'Y'; $itme[6] = 1; $itms[6] = 1; $itmsk[6] = '';
	}
	
	
	$nick=$udata['nick'];
	$nicks=$udata['nicks'];
	if (strpos($nicks,'Dr. Clef')!==false)
	{
		$art = '击破SCP的纹章';$artk = 'A'; $arte = 1; $arts = 1; $artsk = 'zZ';
	}
	}
	...
	/*}elseif(strpos($nicks,"爱马仕")!==false){
			$nick='爱马仕';
			$msp=$sp=600;$mhp=$hp=250;
			$att*=2;$def/=2;$wd+=150;
			$itm[1] = '印有PP模样的棒棒糖'; $itmk[1] = 'HB'; $itme[1] = 75; $itms[1] = '∞';
			$itm[2] = '★捆绑式炸药★'; $itmk[2] = 'Y'; $itme[2] = 1; $itms[2] = 1;
			$itm[5] = '☆爱马仕认证☆'; $itmk[5] = 'Al'; $itme[5] = 1; $itms[5] = 1;$itmsk[5] = 'l';
			$itm[6] = '瘴气弹'; $itmk[6] = 'EW'; $itme[6] = 1; $itms[6] = 1;$itmsk[6] = '10';		
			$db->query("UPDATE {$tablepre}users SET nick='$nick' WHERE ip='".$udata['ip']."'" );*/
	}else{
...
//	}
	...
	$result = $db->query("SELECT * FROM {$tablepre}players WHERE name = '$cuser' AND type = 0");
	if($db->num_rows($result)) {
		header("Location: {$cache_server_addr}game.php");exit();
	}
