...
// [CH] 以下变量请根据空间商提供的账号参数修?如有疑问,请联系服务器提供?
	...
	$server_addr = 'http://localhost:8080/dmdts800test/';                  //服务器域名

	$cache_server_addr = 'http://localhost:8080/dmdts800test/';           //用于有高速服的情况，单机版中只需重复上面的服务器域名即可

	$is_cache_server = 0; 			//本服务器是否是高速服
	...
	$dbpw = 'usbw';			// database password
						// 数据库密?

	$dbname = 'dmdts';			// database name
						// 数据库名
...
// [CH] 以下变量为特别选项,一般情况下没有必要修改
	...
	$gamefounder = '亚莉丝';			// super administrator's UID
...
// [CH] 切勿修改以下变量,仅供程序开发调试用!
	...
	$bbsurl = 'http://localhost:8080/dmdts800test/';    //the bbs url for the game plus
									//安装游戏插件的论坛地址

	$gameurl = 'http://localhost:8080/dmdts800test/';    // the url of game program files,for the full-window mode
									//游戏程序地址，用于全屏模?

	$homepage = 'http://localhost:8080/dmdts800test/';      // game homepage
									//官方网站地址

	$title = '深渊 BR 大逃杀';     //game title
							//游戏标题
