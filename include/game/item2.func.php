...
function newradar($m = 0){
	...
	$npctplist = Array(90,89,40,41,42,43,17,12,11,2,1);//可以探测到NPC的种类
	
	global $nick;//[151009]追加指定前缀可以探测到特定NPC类型的功能
	if(($nick=='幽灵驱逐者')||($nick=='轮回的旅人')){
		$npctplist = Array(90,89,40,41,42,43,17,16,12,11,2,1);//可以探测到NPC的种类
	}
	$tdheight = 20;
...
function newradarex($m = 0){
	...
	$npctplist = Array(11);//可以探测到NPC的种类
	$tdheight = 20;
	$screenheight = count($plsinfo)*$tdheight;
	if (CURSCRIPT == 'botservice') 
	{
